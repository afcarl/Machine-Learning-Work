...
# ================================================================================================================================
m_dataset3 = read.table(file="mvar-set3.dat", header=FALSE)
attach(m_dataset3)
print(m_dataset3)
plot(m_dataset3)
# ================================================================================================================================
...
split_fn = function(split_size){
  splitds = sample(1:nrow(m_dataset3), size=split_size*nrow(m_dataset3))
  train_set <<- m_dataset3[splitds,]
  print(train_set)
  test_set <<- m_dataset3[-splitds,]
  print(test_set)
}
